 ...
 */
public class WSSEPasswordMaskedLoggingInInterceptor extends AbstractPayloadFilteredLoggingInInterceptor {
    private static final Logger LOG = LogUtils.getL7dLogger(WSSEPasswordMaskedLoggingInInterceptor.class);
