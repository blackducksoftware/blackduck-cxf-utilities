 ...
 */
public class PrettyLoggingInInterceptor extends AbstractPayloadFilteredLoggingInInterceptor {

    private static final Logger LOG = LogUtils.getL7dLogger(PrettyLoggingInInterceptor.class);
